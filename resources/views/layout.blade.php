...
<head>
    ...
    <title>Digitf - @yield('title')</title>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav  ">
                            <li class="nav-item active">
                                <a class="nav-link" href="{{ route('homepage', app()->getLocale()) }}">{{__("Home")}}</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <select id="changeLang" class="form-control">
                                    <option @if (app()->getLocale() == 'tr') selected @endif
                                        value="{{ route(Route::currentRouteName(), 'tr') }}">TR</option>
                                    <option @if (app()->getLocale() == 'en') selected @endif
                                        value="{{ route(Route::currentRouteName(), 'en') }}">EN</option>
                                </select>
                            </li>
